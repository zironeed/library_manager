...
from custom_validators import publish_year_validator, isbn_validator
...
class Book(models.Model):
    ...
    isbn = models.IntegerField(max_length=13, verbose_name='book_isbn', validators=[isbn_validator])
